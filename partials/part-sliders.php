			...
			<div class="container box">
				...
				<div class="row">
					...
					<div class="col-sm-12">
						...
						<?php 
							global $redux_demo; 
							$wel_0 = $redux_demo['wel-0'];
							$wel_1 = $redux_demo['wel-1'];
							$wel_2 = $redux_demo['wel-2'];
						?>

						<div class="explore-fun-block" style="width: 100%; text-align: center;">
							<h2><i class="fa <?php echo _e($wel_0, "themesdojo" ); ?>"></i></h2>
							<h2><?php echo _e($wel_1, "themesdojo" ); ?></h2>
							<h4><?php echo _e($wel_2, "themesdojo" ); ?></h4>
						</div>
