				...
				<div class="row">
					...
					<div class="col-sm-12">
						...
						<div class="item-popup-content">
								...
								<div id="buy-buttons" class="full" style="margin-bottom: 0;">
									...
									<script type="text/javascript">
										...
										jQuery("#account_type").change(function() {
										    ...
										    jQuery('#free-payment-package').val(val);
										...
										<div class="row">
											...
											<?php
												...
												if($payment_activate_stripe == 1) {
													$package_price = get_post_meta($post->ID, 'package_price', true);
													$user_current_funds = get_the_author_meta('account_funds', $user_id);
											?>

												<div class="col-sm-<?php if($twobuttons == 1) {?>6<?php  } else { ?>12<?php } ?>">
													<?php if($user_current_funds >= $package_price) { ?>
											...
											<script type="text/javascript">
												...
												jQuery(function($) {
													...
													document.getElementById('paypal-package-button').addEventListener('click', function(e) {
														...
														jQuery('#tdFreeBuyPackage').submit();
							...
							<form id="tdSubmitPaymentPay" method="post" action="<?php echo get_template_directory_uri(); ?>/inc/payments/stripe/td-stripe-payment.php?func=addrow">
							...
							<form id="tdSubmitPaymentFree" method="post" action="<?php echo get_template_directory_uri(); ?>/inc/payments/free/td-free-payment.php?func=addrow">
								                ...
								                success: function(data) {
								                	...
								                	if(data == 4) {
								                		...
								                		if(paymentGateway == "stripe") {
									                		...
									                		jQuery('#tdSubmitPaymentPay').submit();
