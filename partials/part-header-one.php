...
<header id="header" class="header--euvoula--sticker">

    <div class="header--euvoula">
        <div class="header--euvoula--side__a"></div>
        <div class="header--euvoula--logo">
            <?php
        ...
        <div class="header--euvoula--side__b"></div>
    </div>


    <div id="main-menu" class="header--euvoula--main-menu">
