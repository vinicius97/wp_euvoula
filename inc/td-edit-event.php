	...
	$error = 0;
  	...
  	if ( isset( $_POST['tdEditEvent_nonce'] ) && wp_verify_nonce( $_POST['tdEditEvent_nonce'], 'tdEditEvent_html' ) ) {
		...
		if($response == 1) {
			...
			// Partners
			if(isset($_POST['listing-upload-partners-image-data'])) {
				$item_partners = $_POST['listing-upload-partners-image-data'];
				} else{
					$item_partners = "";
			}
			...
			//Schedule
			if(isset($_POST['listing-upload-schedule'])) { 
				$item_schedule = $_POST['listing-upload-schedule']; 
				} else {
					$item_schedule = "";
			}
			...
			//Speaker's Name
			if(isset($_POST['listing-upload-speakers-image-data'])) { 
				$item_speaker_name = $_POST['listing-upload-speakers-image-data']; 
				} else {
					$item_speaker = "";
			}
			...
			//Speaker's Info
			if(isset($_POST['listing-upload-speakers-image-data'])) { 
				$item_speaker_about = $_POST['listing-upload-speakers-image-data']; 
				} else {
					$item_speaker_about = "";
			}
			...
			//Speaker's Link
			if(isset($_POST['listing-upload-speakers-image-data'])) { 
				$item_speaker_link = $_POST['listing-upload-speakers-image-data']; 
				} else {
					$item_speaker_link = "";
			}
			...
			//Speaker Small Info
			if(isset($_POST['speakerComment'])) { 
				$speaker_comment = sanitize_text_field($_POST['speakerComment']);
				} else {
					$speaker_comment = "";
			}
