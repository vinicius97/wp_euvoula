...
function themesdojo_metabox_speakers_scripts() {
	wp_enqueue_script('media-upload');
	wp_enqueue_script('thickbox');
	wp_enqueue_script('themesdojo-upload');
}
function themesdojo_metabox_speakers_styles() {
	wp_enqueue_style('thickbox');
}
add_action('admin_enqueue_scripts', 'themesdojo_metabox_speakers_scripts');
add_action('admin_print_styles', 'themesdojo_metabox_speakers_styles');
...
function themesdojo_metabox_partners_scripts() {
	wp_enqueue_script('media-upload');
	wp_enqueue_script('thickbox');
	wp_enqueue_script('themesdojo-upload');
}
function themesdojo_metabox_partners_styles() {
	wp_enqueue_style('thickbox');
}
add_action('admin_enqueue_scripts', 'themesdojo_metabox_partners_scripts');
add_action('admin_print_styles', 'themesdojo_metabox_partners_styles');
