			...
			<div class="container box">
				...
				<section class="row"> 
					...
					<?php
						...
						$event_place = wp_get_post_terms( $postID, "event_place" );
						if(!empty($event_place)) {

							$term = get_term( $event_place[0]->term_id, 'event_place' );
							$event_place_link = get_term_link( $term );
							$event_place_name = $event_place[0]->name;
					...
					<?php $event_address_city = get_post_meta($post->ID, 'event_address_city', true); ?>
					<?php $item_speaker = get_post_meta($post->ID, 'item-speaker', true); $count_speakers = count($item_speaker); ?>
					<?php $speaker_comment = get_post_meta($post->ID, 'speakerComment', true); ?>
					<?php $number_of_seats = get_post_meta($post->ID, 'numberOfSeats', true); ?>
					<?php $seats_comment = get_post_meta($post->ID, 'seatsComment', true);  ?>
					...
					<div class="col-sm-12">
						...
						<div class="item-block-title">
							...
							<i class="fa fa-bookmark"></i><h4><?php _e( 'Event Summary', 'themesdojo' ); ?></h4>
						...
						<div class="item-block-content">
							...
							<div class="row">
								...
								<div class="summery-block">
									...
									<div id="summery-container">
										...
										<div class="event-summery-information">
											...
											<div class="event-summery-main">
												...
												<?php if(!empty($event_place_link)) { ?>

												<a href="<?php echo esc_url($event_place_link); ?>"><?php if(!empty($event_place_name)) { echo esc_attr($event_place_name); } ?></a>
									...
									<div id="summery-container">
										...
										<div class="event-summery-information">
											...
											<div class="event-summery-main">
												...
												<?php $start_unix_time = strtotime($event_start_date); echo $start_time = date("M d",$start_unix_time); ?>
											...
											<div class="event-summery-secondary">
												...
												<?php $start_unix_time = strtotime($event_start_date); echo $start_time = date("Y",$start_unix_time); ?>
									...
									<div id="summery-container">
										...
										<div class="event-summery-information">
											...
											<div class="event-summery-main">
												...
												<?php echo ($count_speakers);?> Speakers

											</div>

											<div class="event-summery-secondary">

												<?php echo ($speaker_comment);?>
									...
									<?php if(!empty($number_of_seats) && !empty($seats_comment)) { ?>
									...
									<div id="summery-container">
										...
										<div class="event-summery-information">
											...
											<div class="event-summery-main">
												...
												<?php echo ($number_of_seats);?>

											</div>

											<div class="event-summery-secondary">

												<?php echo ($seats_comment);?>
										...
										<span class="full">
											...
											<span class="item-address">
												...
												<?php
													...
													if(!empty($event_place_link)) {

												?>

												<a href="<?php echo esc_url($event_place_link); ?>"><?php echo($event_place_name); ?></a>
				...
				<?php		
					$schedule_comment = get_post_meta($post->ID, 'scheduleComment', true);
					$item_schedule = get_post_meta($post->ID, 'item-schedule', true); 
				...
				<div class="col-sm-12">
					...
					<div class="item-block-title">
						...
						<i class="fa fa-hourglass-half"></i><h4><?php _e( 'Event Schedule', 'themesdojo' ); ?></h4>

					</div>

					<div class="item-block-content">

						<div class="schedule-comment-block" style="margin:30px;">

							<?php echo $schedule_comment; ?>
							...
							<div class="container-schedule">	
 								...
 								<ul class="nav schedule-tabs">
									...
									<?php 
										...
										foreach ($item_schedule as $key => $day) { 
											$current++;
											$key++;
									
									?>								

    								<li class='<?php if($current == 1) { ?>active<?php } ?> tabs-class' style="margin-bottom: 0px !important; padding-bottom: 0px !important; width: auto;"><a href='#tab<?php echo $current; ?>' data-toggle="tab"><?php echo "Day $key"; ?></a></li>
 								...
 								<div class="tab-content">
  									...
  									<?php 
           							...
           							<div class='tab-pane <?php if($current == 1) { ?>active<?php } ?>' id='tab<?php echo $current; ?>'>
               							<ul class='schedule-group' >
               								
               							<?php 

               								foreach ($day as $schedule_event) {

               							 ?>

               							 	<?php echo "<div class=\"schedule-border\">"; ?>

                   							<table class="accordion" id="accordion" data-toggle="accordion" style="margin-bottom: 0px;">

                       							<a class="accordion" id="accordion">
                         							<time class="schedule-time"><i class="fa fa-clock-o"></i><?php echo " "; echo $schedule_event[0]; ?></time>
                          							<h4 class='schedule-title'><?php echo $schedule_event[1]; ?></h4>
                         							<div class="plus-schedule">+</div>      
                         							<div class="minus-schedule">-</div>		
                       							</a>

	                       						<div class="schedule-description"><?php echo $schedule_event[2]; ?></div>
				...
				<?php  } ?>
					...
					<?php 
						...
						$item_speaker = get_post_meta($post->ID, 'item-speaker', true); if(!empty($item_speaker))
					...
					<div class="col-sm-12">
						...
						<div>
							...
							<div class="item-block-title">
								...
								<i class="fa fa-bullhorn"></i><h4><?php _e( 'Event Speakers', 'themesdojo' ); ?></h4>
							...
							<div class="item-block-content">
								...
								<div class="row"> 	
									...
									<div class="speakers-list-holder">
										...
										<div class=>
											...
											<?php
												...
												foreach ($item_speaker as $person) { 
													echo "<div id=\"speakers-list-container\">";
													echo "<div class=\"speakers-list-avatar\"><img src='" . bfi_thumb( "$person[0]", $params ) . "' alt='' /></div>";
													echo "<br>";
													echo "<div class=\"speakers-list-name\">$person[2]</div>";
													echo "<br>";
													echo "<div class=\"speakers-list-about\">$person[3]</div>";
													echo "<br>";
													echo "<a class=\"speakers-list-link-button\" href=\"$person[4]\">More Info</a>";
													echo "<br>";
													echo "</div>"; 
										...
										<div class="col-sm-12" style="margin-bottom: 20px;">
											...
											<div class="row">
												...
												<div class="col-sm-4">
													...
													<span class="event-stats-label">Público</span>
					...
					<?php 
						...
						$item_partners = get_post_meta($post->ID, 'item-partners', true);
					...
					<div class="col-sm-12">
						...
						<div>
							...
							<div class="item-block-title">
								...
								<i class="fa fa-file-text-o"></i><h4><?php _e( 'Partners', 'themesdojo' ); ?></h4>
							...
							<div class="item-block-content">
								...
								<div id="pcarousel" class="owl-carousel">
			                        ...
			                        <?php 
										...
										foreach ($item_partners as $logo) {
													echo "<div class=\"partners-list-container\">";
													echo "<img src=\"$logo[0]\">";
													echo "</div>";
			                    ...
			                    <div class="owl-deals-navigation">
