                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'subtitle' => __('', 'redux-framework-demo'),
                            'desc' => __('You can get the key from here: <a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">https://developers.google.com/maps/documentation/javascript/get-api-key</a>', 'redux-framework-demo'),
                            'default' => ''
                            ),
                        /*
                    array(
                    ...
                    */
                        ...
                        array(
                            'id'=>'wel-0',
                            'type' => 'textarea',
                            'title' => __('Header Icon', 'redux-framework-demo'),
                            'subtitle' => __('', 'redux-framework-demo'),
                            'desc' => __('', 'redux-framework-demo'),
                            'default' => 'fa-child'
                        ),
                        ...
                        array(
                            'id'=>'wel-1',
                            'type' => 'textarea',
                            'title' => __('Header First Line Text', 'redux-framework-demo'),
                            'subtitle' => __('', 'redux-framework-demo'),
                            'desc' => __('', 'redux-framework-demo'),
                            'default' => 'EXPLORE THE FUN'
                        ),

                        array(
                            'id'=>'wel-2',
                            'type' => 'textarea',
                            'title' => __('Header Secound Line Text', 'redux-framework-demo'),
                            'subtitle' => __('', 'redux-framework-demo'),
                            'desc' => __('', 'redux-framework-demo'),
                            'default' => 'Discover awesome events around you. And not only :)'
                        ),
                    )
                );
