 ...
 * Import Demos
 */
function eventbuilder_import_files() {
    return array(
        array(
            'import_file_name'             => esc_html__('EventBuilder','themesdojo'),
            'local_import_file'            => trailingslashit( get_template_directory() ) . 'inc/lib/demo_files/content.xml',
            'import_notice'                => wp_kses( __( 'You can see the demo page here: <a href="http://wpeventbuilder.com/" target="_blank">http://wpeventbuilder.com/</a>', 'themesdojo' ), true),
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'eventbuilder_import_files' );
...
function tdUpdateAccountForm() {
  ...
  if ( isset( $_POST['tdUpdateAccount_nonce'] ) && wp_verify_nonce( $_POST['tdUpdateAccount_nonce'], 'tdUpdateAccount_html' ) ) {
	...
	if (!empty($avatar_url)) {
		...
		$user_avatar_url = esc_url_raw($avatar_url);
...
// your fields (the form)
function td_my_events_place_fields($tag) {
	$tag_extra_fields = get_option(MY_CATEGORY_FIELDS);
	if(!empty($tag->term_id)) {
		$term_id = $tag->term_id;
	} else {
	...
	$cat_paces_event_location = isset( $tag_extra_fields[$term_id]['cat_paces_event_location'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location'] ) : '';
	$cat_paces_event_location_address = isset( $tag_extra_fields[$term_id]['cat_paces_event_location_address'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location_address'] ) : '';
	$cat_paces_event_location_phone = isset( $tag_extra_fields[$term_id]['cat_paces_event_location_phone'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location_phone'] ) : '';
	$cat_paces_event_location_site = isset( $tag_extra_fields[$term_id]['cat_paces_event_location_site'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location_site'] ) : '';
	$your_image_url = isset( $tag_extra_fields[$term_id]['your_image_url'] ) ? esc_attr( $tag_extra_fields[$term_id]['your_image_url'] ) : '';
	$cat_paces_event_location_facebook = isset( $tag_extra_fields[$term_id]['cat_paces_event_location_facebook'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location_facebook'] ) : '';
	$cat_paces_event_location_instagram = isset( $tag_extra_fields[$term_id]['cat_paces_event_location_instagram'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location_instagram'] ) : '';
	$cat_paces_event_location_dribbble = isset( $tag_extra_fields[$term_id]['cat_paces_event_location_dribbble'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location_dribbble'] ) : '';
	$cat_paces_event_location_c_btn = isset( $tag_extra_fields[$term_id]['cat_paces_event_location_c_btn'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location_c_btn'] ) : '';
	$cat_paces_event_location_maps_lat = isset( $tag_extra_fields[$term_id]['cat_paces_event_location_maps_lat'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location_maps_lat'] ) : '';
	$cat_paces_event_location_maps_long = isset( $tag_extra_fields[$term_id]['cat_paces_event_location_maps_long'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location_maps_long'] ) : '';
	$cat_paces_event_location_maps_zoom = isset( $tag_extra_fields[$term_id]['cat_paces_event_location_maps_zoom'] ) ? esc_attr( $tag_extra_fields[$term_id]['cat_paces_event_location_maps_zoom'] ) : '';
?>

<div class="form-field">    
	<div class="form-table">
			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Event Location:', 'traveldojo' ); ?></label></th>
				<td>

					<input id="cat_paces_event_location" type="text" size="36" name="cat_paces_event_location" value="<?php $cat_paces_event_location = stripslashes($cat_paces_event_location); echo esc_attr($cat_paces_event_location); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: Paris, France', 'traveldojo' ); ?> </p>

				</td>
			</tr>

			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Address:', 'traveldojo' ); ?></label></th>
				<td>

					<input id="cat_paces_event_location_address" type="text" size="36" name="cat_paces_event_location_address" value="<?php $cat_paces_event_location_address = stripslashes($cat_paces_event_location_address); echo esc_attr($cat_paces_event_location_address); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: 1st Ave, Minneapolis', 'traveldojo' ); ?> </p>

				</td>
			</tr>
			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Phone:', 'traveldojo' ); ?></label></th>
				<td>

					<input id="cat_paces_event_location_phone" type="text" size="36" name="cat_paces_event_location_phone" value="<?php $cat_paces_event_location_phone = stripslashes($cat_paces_event_location_phone); echo esc_attr($cat_paces_event_location_phone); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: +123456789', 'traveldojo' ); ?> </p>
			...
			<tr class="form-field">
				...
				<td>
					...
					<input id="cat_paces_event_location_site" type="text" size="36" name="cat_paces_event_location_site" value="<?php $cat_paces_event_location_site = stripslashes($cat_paces_event_location_site); echo esc_attr($cat_paces_event_location_site); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: www.themesdojo.com', 'traveldojo' ); ?> </p>

				</td>
			</tr>

			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Place Cover Imagee', 'themesdojo' ); ?></label></th>
				<td>
				<?php 
			...
			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Facebook:', 'traveldojo' ); ?></label></th>
				<td>

					<input id="cat_paces_event_location_facebook" type="text" size="36" name="cat_paces_event_location_facebook" value="<?php $cat_paces_event_location_facebook = stripslashes($cat_paces_event_location_facebook); echo esc_attr($cat_paces_event_location_facebook); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: https://www.facebook.com/themesdojo/', 'traveldojo' ); ?> </p>

				</td>
			</tr>

			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Instagran:', 'traveldojo' ); ?></label></th>
				<td>

					<input id="cat_paces_event_location_instagram" type="text" size="36" name="cat_paces_event_location_instagram" value="<?php $cat_paces_event_location_instagram = stripslashes($cat_paces_event_location_instagram); echo esc_attr($cat_paces_event_location_instagram); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: https://www.instagram.com/stickerspub/', 'traveldojo' ); ?> </p>

				</td>
			</tr>

			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Dribbble:', 'traveldojo' ); ?></label></th>
				<td>

					<input id="cat_paces_event_location_dribbble" type="text" size="36" name="cat_paces_event_location_dribbble" value="<?php $cat_paces_event_location_dribbble = stripslashes($cat_paces_event_location_dribbble); echo esc_attr($cat_paces_event_location_dribbble); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: https://dribbble.com/stickerspub', 'traveldojo' ); ?> </p>

				</td>
			</tr>

			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Contact button:', 'traveldojo' ); ?></label></th>
				<td>

					<input id="cat_paces_event_location_c_btn" type="text" size="36" name="cat_paces_event_location_c_btn" value="<?php $cat_paces_event_location_c_btn = stripslashes($cat_paces_event_location_c_btn); echo esc_attr($cat_paces_event_location_c_btn); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: www.themesdojo.com/contact', 'traveldojo' ); ?> </p>

				</td>
			</tr>

			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Maps settings:', 'traveldojo' ); ?></label></th>
				<td>

					<input style="visibility: hidden;" id="cat_paces_event_location_site" type="text" size="36" name="cat_paces_event_location_site" value="<?php $cat_paces_event_location_site = stripslashes($cat_paces_event_location_site); echo esc_attr($cat_paces_event_location_site); ?>" placeholder=""/>
			...
			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Lat:', 'traveldojo' ); ?></label></th>
				<td>

					<input id="cat_paces_event_location_maps_lat" type="text" size="36" name="cat_paces_event_location_maps_lat" value="<?php $cat_paces_event_location_maps_lat = stripslashes($cat_paces_event_location_maps_lat); echo esc_attr($cat_paces_event_location_maps_lat); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: 46.972756', 'traveldojo' ); ?> </p>

				</td>
			</tr>

			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Long:', 'traveldojo' ); ?></label></th>
				<td>

					<input id="cat_paces_event_location_maps_long" type="text" size="36" name="cat_paces_event_location_maps_long" value="<?php $cat_paces_event_location_maps_long = stripslashes($cat_paces_event_location_maps_long); echo esc_attr($cat_paces_event_location_maps_long); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: 27.421875', 'traveldojo' ); ?> </p>

				</td>
			</tr>

			<tr class="form-field">
				<th scope="row" valign="top"><label for="category-page-slider"><?php _e( 'Zoom level:', 'traveldojo' ); ?></label></th>
				<td>

					<input id="cat_paces_event_location_maps_zoom" type="text" size="36" name="cat_paces_event_location_maps_zoom" value="<?php $cat_paces_event_location_maps_zoom = stripslashes($cat_paces_event_location_maps_zoom); echo esc_attr($cat_paces_event_location_maps_zoom); ?>" placeholder=""/>
					<p class="description"><?php _e( 'Example: 9', 'traveldojo' ); ?> </p>
...
// when the form gets submitted, and the category gets updated (in your case the option will get updated with the values of your custom fields above
function td_update_my_events_place_fields($term_id) {
	if($_POST['taxonomy'] == 'event_place'):
		$tag_extra_fields = get_option(MY_CATEGORY_FIELDS);
		$tag_extra_fields[$term_id]['cat_paces_event_location'] = strip_tags($_POST['cat_paces_event_location']);
		$tag_extra_fields[$term_id]['cat_paces_event_location_address'] = strip_tags($_POST['cat_paces_event_location_address']);
		$tag_extra_fields[$term_id]['cat_paces_event_location_phone'] = strip_tags($_POST['cat_paces_event_location_phone']);
		$tag_extra_fields[$term_id]['cat_paces_event_location_site'] = strip_tags($_POST['cat_paces_event_location_site']);
		$tag_extra_fields[$term_id]['your_image_url'] = strip_tags($_POST['your_image_url']);
		$tag_extra_fields[$term_id]['cat_paces_event_location_facebook'] = strip_tags($_POST['cat_paces_event_location_facebook']);
		$tag_extra_fields[$term_id]['cat_paces_event_location_instagram'] = strip_tags($_POST['cat_paces_event_location_instagram']);
		$tag_extra_fields[$term_id]['cat_paces_event_location_dribbble'] = strip_tags($_POST['cat_paces_event_location_dribbble']);
		$tag_extra_fields[$term_id]['cat_paces_event_location_c_btn'] = strip_tags($_POST['cat_paces_event_location_c_btn']);
		$tag_extra_fields[$term_id]['cat_paces_event_location_maps_lat'] = strip_tags($_POST['cat_paces_event_location_maps_lat']);
		$tag_extra_fields[$term_id]['cat_paces_event_location_maps_long'] = strip_tags($_POST['cat_paces_event_location_maps_long']);
		$tag_extra_fields[$term_id]['cat_paces_event_location_maps_zoom'] = strip_tags($_POST['cat_paces_event_location_maps_zoom']);
		update_option(MY_CATEGORY_FIELDS, $tag_extra_fields);
	endif;
}
...
// when a category is removed
add_filter('deleted_term_taxonomy', 'td_remove_my_events_place_fields');
function td_remove_my_events_place_fields($term_id) {
	if($_POST['taxonomy'] == 'event_place'):
		$tag_extra_fields = get_option(MY_CATEGORY_FIELDS);
		unset($tag_extra_fields[$term_id]);
		update_option(MY_CATEGORY_FIELDS, $tag_extra_fields);
...
// category new fields (the form)
add_filter('event_place_add_form_fields', 'td_my_events_place_fields');
add_filter('event_place_edit_form_fields', 'td_my_events_place_fields');

// Update category fields
add_action( 'edited_event_place', 'td_update_my_events_place_fields', 10, 2 );  
add_action( 'create_event_place', 'td_update_my_events_place_fields', 10, 2 );
...
if ( ! function_exists( 'themesdojo_scripts' ) ) :
	...
	function themesdojo_scripts() {
		...
		*/
		...
		/* Owl pCarousel */
		wp_enqueue_style( 'td-owl-pcarousel',    THEME_WEB_ROOT . '/css/owl.pcarousel.css' );
	...
	global $redux_demo; 
	$google_key = "";
	if(isset($redux_demo['google_key'])) { $google_key = $redux_demo['google_key']; }

	if ( is_page_template('templates/template-contact.php') || is_single()) {	
		
			/* loag gmap api script */
			wp_enqueue_script( 'td-google-maps-script', 'https://maps.googleapis.com/maps/api/js?key='.$google_key.'&sensor=true', array( 'jquery' ), '2013-07-18', true );
	...
	function themesdojo_load_map_scripts() { 
		...
		/* loag gmap api script */
		wp_enqueue_script( 'td-google-maps-script', 'https://maps.googleapis.com/maps/api/js?key='.$google_key.'&libraries=geometry', array( 'jquery' ), '2013-07-18', true );
		...
		wp_enqueue_script( 'admin-jquery-ui-script', '//code.jquery.com/ui/1.12.1/jquery-ui.js', array( 'jquery' ), '2013-07-18', true );
...
if ( ! function_exists( 'themesdojo_admin_enqueue' ) ) :
	...
	function themesdojo_admin_enqueue() {
		...
		/* Admin slider script */
		wp_enqueue_style( 'td-ui-style',                "http://code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css", false, "1.0.0", "all");

		/* Main */
		wp_enqueue_style( 'td-admin-style',             THEME_WEB_ROOT . '/css/td_admin_style.css' );

		/* Admin slider script */
		wp_enqueue_script( 'td-admin-depend-script',    'http://code.jquery.com/ui/1.12.1/jquery-ui.js', array('jquery'), TD_THEME_VERSION, true );
		...
		wp_enqueue_script( 'admin-google-maps-script', 'https://maps.googleapis.com/maps/api/js?key='.$google_key.'&v=3.exp&sensor=false', array( 'jquery' ), '2013-07-18', true );
...
function eventbuilder_removeDemoModeLink() { // Be sure to rename this function to something more unique
...
add_action('init', 'eventbuilder_removeDemoModeLink');
