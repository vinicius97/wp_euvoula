											...
											<div id="main-settings-block" class="collapse in">
												...
												<div class="row">
													...
													<div class="col-sm-8">
														...
														<input type="text" name="numberOfSeats" id="numberOfSeats" value="" class="input-textarea" placeholder="50" />


														<input type="text" name="seatsComment" id="seatsComment" value="" class="input-textarea" placeholder="Small Comment" />
