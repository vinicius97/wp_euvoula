...
if(isset($_GET['post'])) {
	...
	if($post_author_id == $user_id)  { 
		...
		//Seats
		$number_of_seats = get_post_meta($postID, 'numberOfSeats', true);
		$seats_comment = get_post_meta($postID, 'seatsComment', true);
		...
		//Speaker, Partners, Schedule
		$item_speaker = get_post_meta($postID, 'item-speaker', true);
		$item_partners = get_post_meta($postID, 'item-partners', true);
		$item_schedule = get_post_meta($postID, 'item-schedule', true);

		$schedule_comment = get_post_meta($postID, 'scheduleComment', true);
		$speaker_comment = get_post_meta($postID, 'scheduleComment', true);
											...
											<div id="main-settings-block" class="collapse in">
												...
												<div class="row">
													...
													<div class="col-sm-8">
														...
														$all_event_places = td_get_all_event_places();

											    		if(!empty($all_event_places)) {
														  	...
														  	jQuery(function() {
															    var availableTags = [
															    	<?php
															    		...
															    		$all_events = array_unique(array_filter($all_event_places));
													...
													<div class="col-sm-4">
														...
														<span class="form-label"><?php _e( 'Number of seats:', 'themesdojo' ); ?></span>

													</div>

													<div class="col-sm-8">

														<input type="text" name="numberOfSeats" id="numberOfSeats" value="<?php if(!empty($number_of_seats)) { echo esc_attr($number_of_seats); } ?>" class="input-textarea" placeholder="50" />


														<input type="text" name="seatsComment" id="seatsComment" value="<?php if(!empty($seats_comment)) { echo esc_attr($seats_comment); } ?>" class="input-textarea" placeholder="Small Comment" />
									...
									<div id="upload-form-holder" style="display: inline-block;">
													...
													<div class="schedule-container">
														...
														<div class="col-sm-12">
															...
															<div class="schedule-desc">
																...
																</br><?php _e( 'Say something about Event Schedule!', 'themesdojo' ); ?></br> </br> 

																<input type="text" name="scheduleComment" id="scheduleComement" value="<?php if(!empty($schedule_comment)) { echo $schedule_comment; } ?>" class="input-textarea" placeholder="" />
															...
															<div id="listing-upload-schedule-day" class="schedule-upload-schedule">
																...
																<?php
																	...
																	if(!empty($item_schedule)) {

																	$current = 0;

																	foreach ($item_schedule as $day) {
																		
																		
												
																?>

																	<div class="schedule_item" day="<?php echo $current; ?>">

																		<?php 
																			$key = 0;
																			foreach ($day as $key => $schedule_event) {
																				
																		?>

																		<div class="schedule-holder" event="<?php echo $key; ?>">

																			<input class="listing-upload-schedule" type="text" name="listing-upload-schedule[<?php echo $current; ?>][<?php echo $key; ?>][0]" placeholder="Time" value="<?php echo $schedule_event[0]; ?>"  />
																			<input class="listing-upload-schedule" id="listing-upload-schedule-data" type="text" name="listing-upload-schedule[<?php echo $current; ?>][<?php echo $key; ?>][1]" placeholder="Name" value="<?php echo $schedule_event[1]; ?>" />
																			<input class="listing-upload-schedule-data-description" id="listing-upload-schedule-data" type="text" name="listing-upload-schedule[<?php echo $current; ?>][<?php echo $key; ?>][2]" placeholder="Description" value="<?php echo $schedule_event[2]; ?>" />
										...
										<div class="item-block-content">
											...
											<div id="speakers-block" class="collapse in">
												...
												<div class="row">
													...
													<div id="listing-upload-speakers">
														...
														<?php
															...
															if(!empty($item_speaker)) {

															$currentId = 0;
															
															foreach ($item_speaker as $person) { 

																$currentId++;
																$full_img_url = $person[0];
														...
														<div class="option_item" id="<?php echo esc_attr($currentId); ?>">
															...
															<div class="listing-upload-speakers-image">
																...
																<span class="speakers-image-holder" style="background-image: url(<?php echo esc_url(bfi_thumb( $full_img_url, $params )); ?>);"></span> 
																<span class="speakers-image-background"><i class="fa fa-file-image-o"></i></span> 

															</div>
																			
															<input class="listing-upload-speakers-image-data-url" id="listing-upload-speakers-image-data[<?php echo $currentId; ?>][0]" type="hidden" value="<?php echo esc_attr($person[0]); ?>" name="listing-upload-speakers-image-data[<?php echo esc_attr($currentId); ?>][0]" />
															<input class="listing-upload-speakers-image-data-id" id="" type="hidden" name="" />

															<a href="#" class="td-buttom speakers-avatar-upload-image" style="display: none;"><?php _e( 'Upload', 'themesdojo' ); ?></a>
															<a href="#" class="td-buttom speakers-avatar-delete-image"><i class="fa fa-trash-o"></i><?php _e( 'Delete', 'themesdojo' ); ?></a>

															<input class="listing-upload-speakers-image-data-name" id="listing-upload-speakers-image-data[<?php echo $currentId; ?>][2]" type="text" placeholder="Name" value="<?php echo esc_attr($person[2]); ?>" name="listing-upload-speakers-image-data[<?php echo esc_attr($currentId); ?>][2]" />
															<input class="listing-upload-speakers-image-data-about" id="listing-upload-speakers-image-data[<?php echo $currentId; ?>][3]" type="text" placeholder="About you" value="<?php echo esc_attr($person[3]); ?>" name="listing-upload-speakers-image-data[<?php echo esc_attr($currentId); ?>][3]" />
															<input class="listing-upload-speakers-image-data-link" id="listing-upload-speakers-image-data[<?php echo $currentId; ?>][4]" type="text" placeholder="Link" value="<?php echo esc_attr($person[4]); ?>" name="listing-upload-speakers-image-data[<?php echo esc_attr($currentId); ?>][4]" />
												...
												<input type="text" name="speakerComment" id="speakerComement" value="<?php echo esc_attr($speaker_comment) ?>" class="input-textarea" placeholder="Say something about them!" />
												...
												<div class="row">
													...
													<div id="listing-upload-partners">
														...
														<?php
															...
															if(!empty($item_partners)) {

															$currentId = 0;

															foreach($item_partners as $logo) {
																$currentId++;
														...
														<div class="option_item" id="<?php echo esc_attr($currentId);?>">
															...
															<div class="listing-upload-partners-image">
																...
																<span class="partners-image-holder" style="background-image: url(<?php echo esc_url(bfi_thumb( $full_img_url, $params )); ?>);"></span> 
																<span class="partners-image-background"><i class="fa fa-file-image-o"></i></span> 

															</div>
																			
															<input class="listing-upload-partners-image-data-url" id="listing-upload-partners-image-data[<?php echo esc_attr($currentId); ?>][0]" type="hidden" name="listing-upload-partners-image-data[<?php echo esc_attr($currentId); ?>][0]" value="<?php echo esc_url($full_img_url); ?>" />
															<input class="listing-upload-partners-image-data-id" id="listing-upload-partners-image-data-[<?php echo esc_attr($currentId); ?>][1]" type="hidden" name="listing-upload-partners-image-data[<?php echo esc_attr($currentId); ?>][1]" value="<?php echo esc_url($full_img_url); ?>" />

															<a href="#" class="td-buttom partners-avatar-upload-image" style="display: none;" ><?php _e( 'Upload', 'themesdojo' ); ?></a>
															<a href="#" class="td-buttom partners-avatar-delete-image"><i class="fa fa-trash-o"></i><?php _e( 'Delete', 'themesdojo' ); ?></a>
															...
															<script>
																...
																jQuery(document).on('click','.partners-avatar-delete-image', function(e) {
																	...
																	jQuery(this).parent().find(".partners-avatar-delete-image").css("display", "inline-block");
																	jQuery(this).css("display", "none");
																});
