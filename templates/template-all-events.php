							...
							<div class="row">
								...
								<div class="col-sm-4">
									...
									<div class="full">
										...
										<span id="show-map-button" data-rel="tooltip" rel="top" title="<?php _e( "Show Map", "themesdojo" ); ?>"><i class="fa fa-map-marker"></i></span>

										<span id="show-list-button" data-rel="tooltip" rel="top" title="<?php _e( "List View", "themesdojo" ); ?>"><i class="fa fa-th-list"></i></span>

										<span id="show-grid-button" data-rel="tooltip" rel="top" title="<?php _e( "Grid View", "themesdojo" ); ?>"><i class="fa fa-th-large"></i></span>
								...
								<div class="row">
											...
											<div class="col-sm-12">
												...
												<span class="page-title-aright query-results-count">
													...
													<span><?php echo esc_attr($total_items); ?></span> <?php if($total_items == 1) { echo  'Resultado encontrado '; } elseif($total_items == 0) { echo  'Nenhum resultado encontrado '; } else {  echo  'Resultados  ';  } ?>
											...
											<div class="col-sm-12">
												...
												<input type="text" name="filterKeywords" id="filterKeywords" value="<?php echo esc_attr($keyword); ?>" class="input-textarea" placeholder='Palavras chave' />
											...
											<div class="col-sm-12">
												...
												<select id="listingFormTime" name="listingFormTime">
													...
													<option value="" <?php selected( $time, "" ); ?>>Há qualquer momento</option>
													<option value="1" <?php selected( $time, 1 ); ?>>Hoje</option>
													<option value="2" <?php selected( $time, 2 ); ?>>Esta semana</option>
													<option value="3" <?php selected( $time, 3 ); ?>>Este mês</option>
											...
											<div class="col-sm-12">
												...
												<select id="listingFormCat" name="category">
													...
													<option value="">Qualque categoria</option>
											...
											<div class="full-width-buttons col-sm-12">
												...
												<button class="td-buttom" id="submit-filter" name="submit" type="submit"><i class="fa fa-check"></i>Atualizar resultados</button>

												<button class="td-buttom" id="reset-filter" name="submit" type="submit" style="margin-bottom: 0!important"><i class="fa fa-times"></i> Zerar </button>
						...
						<div class="row">
							...
							<div id="cat-listing-holder">
								...
								?>
									...
									<div class="col-sm-6 id-<?php echo get_the_ID(); ?>">
