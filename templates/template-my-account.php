					...
					<div class="col-sm-12">
						...
						<div id="my-account-content">
						    ...
						    <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
						    	...
						    	<li class="active"><a href="#my-funds" data-toggle="tab"><i class="fa fa-money"></i><span><h3><?php _e( 'Account Funds', 'themesdojo' ); ?></h3></span><i class="fa fa-chevron-right"></i></a></li>

						        <li><a href="#my-events" data-toggle="tab"><i class="fa fa-ticket"></i><span><h3><?php _e( 'My Events', 'themesdojo' ); ?></h3></span><i class="fa fa-chevron-right"></i></a></li>
						    ...
						    <div id="my-tab-content" class="tab-content">
						    	...
						    	<div class="tab-pane active" id="my-funds">
						    		<div class="item-block-title">
										<i class="fa fa-money"></i><h4><?php _e( 'Account Funds', 'themesdojo' ); ?></h4>
									</div>
									<div id="my-events-holder" class="item-block-content item-block-funds item-image-gallery-block">
										<span>You currently have: <?php the_author_meta('account_funds', $user_id); ?></span>
										<hr>
										<form method="post">
											<span><label for="topup_amount"><?php _e( 'Top-up Account Funds', 'flatads' ); ?></label></span>
											<p class="form-row form-row-first">
												...
												<span class="description">
													...
													printf(
														'%s%s%s',
														$min_topup ? sprintf( __( 'Minimum: <strong>%s</strong>.', 'flatads' ), wc_price( $min_topup ) ) : '',
														$min_topup && $max_topup ? ' ' : '',
														$max_topup ? sprintf( __( 'Maximum: <strong>%s</strong>.', 'flatads' ), wc_price( $max_topup ) ) : ''
													);
													?>
												</span>
												<?php endif; ?>
											...
											<p class="form-row">
												<input type="hidden" name="flatads_WC_Account_Funds_topup" value="true" />
												<input type="submit" class="funt-btn button" value="<?php _e( 'Top-up', 'flatads' ); ?>" />
											</p>
