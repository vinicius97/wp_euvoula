...
class upcoming_events_Widget extends WP_Widget {
	  ...
	  function __construct() {
		$widget_ops = array('classname' => 'upcoming_events_Widget', 'description' => __( 'ThemesDojo Recent Posts Widget', 'themesdojo') );
		parent::__construct('upcoming_events_Widget', __('ThemesDojo - Upcoming Events Widget', 'themesdojo'), $widget_ops);
		$this->alt_option_name = 'upcoming_events_Widget';
